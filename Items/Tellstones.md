...
There are many versions of this game all across Runeterra, but the rules remain mostly the same, having only differences in the symbols used. It's a game of memory and bluff.
